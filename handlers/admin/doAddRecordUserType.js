...
const isRecordUserTypeKeyAvailable = async (recordUserTypeKey) => {
...
const generateRecordUserTypeKey = async (recordUserTypeKey, recordUserType) => {
    cache.clearCache();
    ...
    const recordUserTypeKeyRoot = (recordUserTypeKey === ""
        ? (recordUserType
            .toLowerCase()
            .trim()
            .replace(/[^_a-z-]/g, "-"))
